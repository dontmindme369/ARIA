...
class AnchorAutoTuner:
    ...
    def _adjust_weights(self):
        ...
        """
        print(f"\n🔧 Auto-tuning anchor weights (after {self.adjustment_frequency} selections)...")
        ...
        for mode, anchor in self.anchors.items():
            ...
            # Case 1: High selection rate but low performance → Reduce weights
            ...
            # Case 2: Low selection rate but high performance → Increase weights
    ...
    def _load_state(self):
        ...
        try:
            ...
            print(f"✓ Loaded anchor auto-tuner: {self.total_selections} selections tracked")
